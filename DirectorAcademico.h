...
class DirectorAcademico{
    ...
    public:
        DirectorAcademico(std::string nombre, std::string apellidos, std::string carrera, char[9] dni, std::string correo, std::string departamento) {nombre_=nombre; apellidos_=apellidos; carrera_=carrera; dni_=dni; correo_=correo; departamento_=departamento;}
